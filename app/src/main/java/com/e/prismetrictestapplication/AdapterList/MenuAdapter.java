...
public class MenuAdapter extends BaseAdapter {
    ...
    private ArrayList<MyDuoOptionView> mOptionViews = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final MyDuoOptionView optionView;
        if (convertView == null) {
            optionView = new MyDuoOptionView(parent.getContext());
        } else {
            optionView = (MyDuoOptionView) convertView;
        }
